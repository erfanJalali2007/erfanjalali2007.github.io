...
import { Mail, Copy, Check, Send, Github, Linkedin, Gamepad2, Sparkles, MapPin, Clock, Loader2 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 space-y-5">
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-white mb-2">Let's build together</h3>
            <p className="text-xs sm:text-sm text-slate-200 font-normal leading-relaxed mb-6">
              Available for game development contracts, Unity systems programming, shader engineering, and technical advisory.
            </p>
            ...
            <div className="p-3.5 rounded-2xl bg-white/[0.06] border border-white/15 mb-5">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-xl bg-white/15 hover:bg-white/25 text-white transition-colors flex items-center gap-1.5 text-xs font-mono font-medium shrink-0 rgb-interactive-option border border-white/20"
            ...
            <div className="grid grid-cols-3 gap-2 mt-6">
              <a
                href="https://github.com/erfanjalali2007"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/erfanjalali"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/15 flex flex-col items-center justify-center gap-1.5 text-slate-200 hover:text-white transition-colors rgb-interactive-option"
              >
              ...
              <a
                href="https://erfanjalali.itch.io"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/15 flex flex-col items-center justify-center gap-1.5 text-slate-200 hover:text-white transition-colors rgb-interactive-option"
              >
                <Gamepad2 size={18} />
                <span className="text-xs font-mono font-medium">Itch.io</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-7">
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-white mb-1">Send a Message</h3>
            <p className="text-xs sm:text-sm text-slate-300 font-normal mb-6">
              Have a project, game jam idea, or technical question? Drop a note below.
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your game idea, project requirements, or question..."
                ...
                <button
                  ...
                  id="btn-send-message"
                  className="w-full py-3 rounded-xl bg-white/20 hover:bg-white/30 text-white text-xs sm:text-sm font-semibold transition-all flex items-center justify-center gap-2 border border-white/30 shadow-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed rgb-interactive-option"
                >
                  {isSubmitting ? (
                    <>
                      <Loader2 size={15} className="animate-spin" />
                      <span>Transmitting via Worker...</span>
                    </>
                  ) : (
                    <>
                      <Send size={15} className={theme.accentClass.icon} />
